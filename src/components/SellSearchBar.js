...
export default function SellSearchBar(props) {
  ...
  return (
    <div className='search-form'>
      ...
      <p> Search for book title and auto-fill details</p>
      <div className='home-search-container'>
        <div className='home-search-content'>
          <form className='searchForm'>
            <div className='search-form-element'>
              <input type='text' value={searchValue} onChange={(e) => { setSearchValue(e.target.value) }} className='form-control2' placeholder='Enter Book Title'></input>
      ...
      {success && searchValue && result ? <div className='search-results'>
        ...
        <ul>
          ...
          {result.map((value, index) => (
            ...
            <li key={index}><button className='resultButton' onClick={() => {
              const newBookName = value.volumeInfo;
              setSearchValue("")
              props.setSellBook(newBookName);
            }}>{value.volumeInfo.title}</button>
